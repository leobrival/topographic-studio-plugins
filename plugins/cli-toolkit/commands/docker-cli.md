---
title: Docker CLI
description: Docker CLI commands for managing containers and images
allowed-tools: [Bash(docker *)]
---

Comprehensive cheat-sheet for `docker` commands to manage containers, images, networks, and volumes.
...
docker tag myapp:prod registry.example.com/myapp:v1.0
docker push registry.example.com/myapp:v1.0

# Volume and network setup
docker network create myapp-network
docker volume create myapp-data
docker run -d --name database --network myapp-network -v myapp-data:/var/lib/mysql mysql:8.0
docker run -d --name app --network myapp-network -p 8080:80 myapp:latest
...
docker tag myapp:latest registry.example.com/myapp:v2.0
docker push registry.example.com/myapp:v2.0
```
