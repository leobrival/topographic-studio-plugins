---
title: Vercel CLI
description: Vercel CLI commands for managing serverless applications
allowed-tools: [Bash(vercel *)]
---

Comprehensive documentation of the Vercel CLI for deploying and managing serverless applications on Vercel.
...
# Initialise a specific example/template
...
# Force transfer if the domain is already linked elsewhere
...
To use Vercel CLI in automated environments:

1. Create a token in your Vercel dashboard.
2. Pass the token via the `--token` flag.
